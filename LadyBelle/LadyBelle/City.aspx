<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="City.aspx.cs" Inherits="LadyBelle.City" %>
                     ...
                     <table>
                        <tr>
                            <td>
                                <asp:DataGrid ID="dgList" runat="server" BorderWidth="1px" CssClass="table_grid" AutoGenerateColumns="false" AllowPaging="True" PageSize="10" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" CellPadding="4" ForeColor="Black" GridLines="Vertical" OnItemCommand="dgList_ItemCommand" OnPageIndexChanged="dgList_PageIndexChanged">
                                    ...
                                    <Columns>
                                        <asp:ButtonColumn DataTextField="CityID" HeaderText="City ID" CommandName="id">
                                        ...
                                        <asp:BoundColumn DataField="ProvinceName" HeaderText="Province">
                                            <HeaderStyle Wrap="False" />
                                            <ItemStyle Wrap="False" />
                                        </asp:BoundColumn>
                        ...
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td style="width: 100px">City ID</td>
                                        <td>:</td>
                                       <td style="width: 210px"><asp:TextBox runat="server" ID="txtCityID" width="60" 
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:TextBox ID="txtCityName" runat="server" Width="200"></asp:TextBox></td>
                                        <td>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                ErrorMessage="*" ForeColor="Red" ControlToValidate="txtCityName" 
                                                ValidationGroup="province"></asp:RequiredFieldValidator></td>
                                    </tr>
                                       <tr>
                                        <td>Province</td>
                                        <td style="width: 10px">:</td>
                                        <td><asp:DropDownList ID="cmbProvince" runat="server" Width="200"></asp:DropDownList></td>
                                        <td>
