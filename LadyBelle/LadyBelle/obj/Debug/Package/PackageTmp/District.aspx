<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="District.aspx.cs" Inherits="LadyBelle.District" %>
                     ...
                     <table>
                        <tr>
                            <td>
                                <asp:DataGrid ID="dgList" runat="server" BorderWidth="1px" CssClass="table_grid" AutoGenerateColumns="false" AllowPaging="True" PageSize="10" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" CellPadding="4" ForeColor="Black" GridLines="Vertical" OnItemCommand="dgList_ItemCommand" OnPageIndexChanged="dgList_PageIndexChanged">
                                    ...
                                    <Columns>
                                        <asp:ButtonColumn DataTextField="DistrictID" HeaderText="District ID" CommandName="id">
                        ...
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td style="width: 100px">District ID</td>
                                        <td>:</td>
                                       <td style="width: 210px"><asp:TextBox runat="server" ID="txtDistrictID" width="60" 
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:TextBox ID="txtDistrictName" runat="server" Width="200"></asp:TextBox></td>
                                        <td>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                ErrorMessage="*" ForeColor="Red" ControlToValidate="txtDistrictName" 
                                    ...
                                    <tr>
                                        <td>City</td>
                                        <td style="width: 10px">:</td>
                                        <td><asp:DropDownList ID="cmbCity" runat="server" Width="200"></asp:DropDownList></td>
                                        <td>
